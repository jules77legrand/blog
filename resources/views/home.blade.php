			...
			<div class="container-fluid px-4">
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								<h3>M. NGOM</h3>
								<span class="position mb-2">Professeur de Mathematiques</span>
								<div class="faded">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/teacher-12.jpg);"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>M.FAYE</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/teacher-15.jpg);"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>M.CAMARA</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/teacher-13.jpg);"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>M.DACOSTA</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/teacher-11.jpg);"></div>
							</div>
							<div class="text pt-3 text-center">
								<h3>M.DIOP</h3>
		 ...
		 class="ftco-section">
			<div class="container-fluid px-4">
				<div class="row">
					...
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/enquete-11.jpg);"></div>
						<div class="text pt-4">
					...
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/enquete-2.jpg);"></div>
						<div class="text pt-4">
					...
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/enquete-5.jpg);"></div>
						<div class="text pt-4">
					...
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/enquete-6.jpg);"></div>
						<div class="text pt-4">
					...
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/enquete-3.jpg);"></div>
						<div class="text pt-4">
					...
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/enquete-10.jpg);"></div>
						<div class="text pt-4">
					...
					<div class="col-md-3 course ftco-animate">
						<div class="img" style="background-image: url(images/enquete-7.jpg);"></div>
						<div class="text pt-4">
